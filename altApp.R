...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      uiOutput("locSelector"),
      
      uiOutput("statusSelector"),
      ...
      uiOutput("depVarSelector"),
      
      uiOutput("indVarSelector")
